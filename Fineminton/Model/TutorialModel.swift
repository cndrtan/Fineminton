...
public class TutorialModel {
    ...
    public func getStepList() -> Array<TutorialStep> {
        ...
        let step1 = TutorialStep(sequenceNumber: 0, title: "Tahap 1", mediaSource: "l0t0", firstLineDescription: "Genggamlah raket dengan benar (bisa menggunakan \"Handhsake\" atau \"Pistol\" grip).", description: "", mediaType: "image")
        let step2 = TutorialStep(sequenceNumber: 1, title: "Tahap 2", mediaSource: "l0t1", firstLineDescription: "Lakukanlah \"Waiting\" atau \"Receiving\" stance.", description: "Tahan lengan Anda yang memegang raket dalam posisi pinggiran raket menghadap ke atas. \nAtur keseimbangan Anda pada kedua kaki secara merata.", mediaType: "image")
